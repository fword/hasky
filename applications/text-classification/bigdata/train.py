...
flags.DEFINE_boolean('mean_cost', False, 'use reduce_mean or reduce_sum for cost/loss')
...
def train():
  with tf.Graph().as_default():
    ...
    data_files = []
    data_files.append('hdfs://nj01-nanling-hdfs.dmop.baidu.com:54310/app/tuku/chenghuige/tf-record/train')
