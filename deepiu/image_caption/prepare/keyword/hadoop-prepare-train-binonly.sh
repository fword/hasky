...
$HADOOP_HOME/bin/hadoop streaming \
	...
	-input $input \
	-output $output \
	-mapper "sh ./hadoop-write-bin.sh gen-records-streaming.py $train_output_path train 1" \
	-reducer NONE \
	-file "./hadoop.config" \
	...
	-jobconf mapred.job.name="chenghuige-prepare-train-binonly" \
...
#$HADOOP_HOME/bin/hadoop fs -getmerge $train_count_path  $local_train_output_path/num_records.hdfs.txt
