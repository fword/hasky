...
$HADOOP_HOME/bin/hadoop streaming \
	...
	-input $input \
	-output $output \
	-mapper "cp ./conf.py $image_caption_lib_path; sh ./hadoop-write-bin.sh gen-records-streaming.py $train_output_path train 2" \
	...
	-jobconf mapred.job.name="chenghuige-prepare-train-countonly" \
...
$HADOOP_HOME/bin/hadoop fs -get $train_count_path/part-00000  $local_train_output_path/num_records.hdfs.txt
