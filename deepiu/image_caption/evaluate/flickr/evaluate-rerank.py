...
#flags.DEFINE_string('algo', 'rnn', '')
flags.DEFINE_string('algo2', 'rnn', '')
#flags.DEFINE_string('algo2', 'show_and_tell', '')


flags.DEFINE_string('model_dir', '/home/gezi/data/models/model.flickr.bow/', '')  
#flags.DEFINE_string('model_dir', '../../model.flickr.rnn.simple7/', '')  
flags.DEFINE_string('model2_dir', '../../model.flickr.rnn.simple7/', '')  
#flags.DEFINE_string('model2_dir', '../../model.flickr.show_and_tell/', '')  
