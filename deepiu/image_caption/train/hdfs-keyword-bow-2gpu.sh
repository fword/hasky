cp ./prepare/bow/keyword/conf.py conf.py
source ./prepare/bow/keyword/config 

dir=/home/gezi/temp/image-caption/ 
model_dir=$dir/model.keyword.bow.batch128
mkdir -p $model_dir
cp ./train/hdfs-keyword-bow-batch128.sh $model_dir
