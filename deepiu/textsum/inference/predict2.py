...
def gen_predict_graph(predictor, scope):  
  score = predictor.init_predict()
  tf.add_to_collection('score', score)
  
  scope.reuse_variables()
  #-----generateive
  text, text_score = predictor.init_predict_text(decode_method=SeqDecodeMethod.greedy, 
  ...
  return text, text_score, beam_text, beam_text_score
